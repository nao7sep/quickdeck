...
// and since Safari 27 so does focus a script moves after keyboard use. About,
// Shortcuts and Error opened on their own scrolling body, and the key that opened
// them lit its ring as a second border inside the modal.
//
...
const COVERING_STYLESHEET = "src/styles.css";
