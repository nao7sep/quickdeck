// The one shared command-modifier predicate (both Cmd and Ctrl on every
// platform, Alt excluded — keyboard-shortcut-conventions).
...
// (The shared command-modifier predicate is imported at the top of the file —
// local duplication here is exactly where the both-modifiers fix was forgotten
// once, so zoom imports it instead.)
